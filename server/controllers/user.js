...
export const verify = async (req, res) => {
    try {
        ...
        if (user.otp !== otp || user.otp.otp_expiry < Date.now()) {
...
export const updateTask = async(req,res)=>{
  try {
    ...
    res.status(500).json({uccess:true , message:"Task updated successfully"})
...
export const forgotPassword = async(req,res)=>{
    ...
    const message = `Your OTP for reseting the password ${otp}. If you did not request fot this, please ignore this email.`
